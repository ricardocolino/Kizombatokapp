...
const resources = {
  ...
  es: {
    translation: {
      ...
      "Support creator coins": "Apoya al creador con AngoCoins",
  ...
  fr: {
    translation: {
      ...
      "Support creator coins": "Soutenez le créateur avec des AngoCoins",
  ...
  ru: {
    translation: {
      ...
      "Support creator coins": "Поддержите автора с помощью AngoCoins",
  ...
  zh: {
    translation: {
      ...
      "Save Changes": "保存更改",
      "Send Gift": "发送礼物",
      "Support creator coins": "用 AngoCoins 支持创作者",
