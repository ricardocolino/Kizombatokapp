...
const resources = {
  en: {
    translation: {
      ...
      "Charge AngoCoins": "Charge Angochat Coins",
      ...
      "Min withdraw amount": "Minimum withdrawal amount via USDT (BEP-20) is $0.50000 USD.",
      ...
      "Min required": "Minimum required: $0.50000 USD",
      "Wait": "Wait...",
      ...
      "Unclaimed": "Unclaimed",
      "Claim Now": "Claim Now",
      "Automated Earnings": "Automated Earnings",
      ...
      "Earnings claimed success": "Earnings claimed successfully! You won ${{amount}} USD. 🇦🇴🚀",
      ...
      "Insufficient AngoCoins": "Not enough Angochat Coins! Top up your balance in your profile.",
      "Send Gift": "Send Gift",
      "Support creator coins": "Support the creator with Angochat Coins",
      "Deduction message": "The amount will be deducted from your balance and sent to the author.",
      "Liked by Creator": "Liked by Creator",
      "Flower": "Flower",
      "Heart": "Heart",
      "Star": "Star",
      "Fire": "Fire",
  ...
  pt: {
    translation: {
      ...
      "Suggested Profiles": "Perfis em Crescimento",
      ...
      "Charge AngoCoins": "Carregar Angochat Coins",
      ...
      "Min withdraw amount": "Valor mínimo para levantamento via USDT (BEP-20) é de $0.50000 USD.",
      ...
      "Min required": "Mínimo necessário: $0.50000 USD",
      "Wait": "Aguarda...",
      ...
      "Automated Earnings": "Resgate Automático",
      ...
      "Earnings claimed success": "Ganhos resgatados com sucesso! Ganhaste ${{amount}} USD. 🇦🇴🚀",
      ...
      "Insufficient AngoCoins": "Não tens Angochat Coins suficientes! Carrega o teu saldo no perfil.",
      "Send Gift": "Enviar Presente",
      "Support creator coins": "Apoia o criador com Angochat Coins",
      "Deduction message": "O valor será descontado do teu saldo e enviado para o autor.",
      "Liked by Creator": "Curtido pelo autor",
      "Flower": "Flor",
      "Heart": "Coração",
      "Star": "Estrela",
      "Fire": "Fogo",
      ...
      "Network": "Rede",
      "Copy": "Copiar",
      "Sent gifts message": "Enviaste {{amount}} Angochat Coins para {{name}}!",
      ...
      "Welcome to huzty": "Bem-vindo ao angochat! 🇦🇴",
  ...
  es: {
    translation: {
      ...
      "Support creator coins": "Apoya al creador con Angochat Coins",
      "Deduction message": "El valor será descontado de tu saldo y enviado al autor.",
      "Liked by Creator": "Le gustó al autor",
      "Flower": "Flor",
      "Heart": "Corazón",
      "Star": "Estrella",
      "Fire": "Fuego",
      "Trophy": "Trofeo",
      "Diamond": "Diamante",
      "Creator Support": "Apoyo al creador",
      "Sent gifts message": "¡Enviaste {{amount}} Angochat Coins a {{name}}!",
  ...
  fr: {
    translation: {
      ...
      "Support creator coins": "Soutenez le créateur avec des Angochat Coins",
      "Deduction message": "Le montant sera déduit de votre solde et envoyé à l'auteur.",
      "Liked by Creator": "Aimé par l'auteur",
      "Flower": "Fleur",
      "Heart": "Cœur",
      "Star": "Étoile",
      "Fire": "Feu",
      "Trophy": "Trophée",
      "Diamond": "Diamant",
      "Creator Support": "Soutien au créateur",
      "Sent gifts message": "Vous avez envoyé {{amount}} Angochat Coins à {{name}} !",
  ...
  ru: {
    translation: {
      ...
      "Support creator coins": "Поддержите автора с помощью Angochat Coins",
      "Deduction message": "Сумма будет списана с вашего баланса и отправлена автору.",
      "Liked by Creator": "Понравилось автору",
      "Flower": "Цветок",
      "Heart": "Сердце",
      "Star": "Звезда",
      "Fire": "Огонь",
      "Trophy": "Кубок",
      "Diamond": "Алмаз",
      "Creator Support": "Поддержка автора",
      "Sent gifts message": "Вы отправили {{amount}} Angochat Coins пользователю {{name}}!",
  ...
  zh: {
    translation: {
      ...
      "Save Changes": "保存更改",
      "Send Gift": "发送礼物",
      "Support creator coins": "用 Angochat Coins 支持创作者",
      "Deduction message": "该金额将从您的余额中扣除并发送给作者。",
      "Liked by Creator": "作者觉得很赞",
      "Flower": "花朵",
      "Heart": "爱心",
      "Star": "星星",
      "Fire": "火焰",
      "Trophy": "奖杯",
      "Diamond": "钻石",
      "Creator Support": "支持创作者",
      "Sent gifts message": "您向 {{name}} 发送了 {{amount}} 个 Angochat Coins！",
