...
const resources = {
  en: {
    translation: {
      ...
      "Charge AngoCoins": "Charge Huzty Coins",
      ...
      "Insufficient AngoCoins": "Not enough Huzty Coins! Top up your balance in your profile.",
      "Send Gift": "Send Gift",
      "Support creator coins": "Support the creator with Huzty Coins",
      ...
      "Network": "Network",
      "Copy": "Copy",
      "Sent gifts message": "You sent {{amount}} Huzty Coins to {{name}}!",
  ...
  pt: {
    translation: {
      ...
      "Charge AngoCoins": "Carregar Huzty Coins",
      ...
      "Insufficient AngoCoins": "Não tens Huzty Coins suficientes! Carrega o teu saldo no perfil.",
      "Send Gift": "Enviar Presente",
      "Support creator coins": "Apoia o criador com Huzty Coins",
      ...
      "Network": "Rede",
      "Copy": "Copiar",
      "Sent gifts message": "Enviaste {{amount}} Huzty Coins para {{name}}!",
  ...
  es: {
    translation: {
      ...
      "Support creator coins": "Apoya al creador con Huzty Coins",
      ...
      "Sent gifts message": "¡Enviaste {{amount}} Huzty Coins a {{name}}!",
  ...
  fr: {
    translation: {
      ...
      "Support creator coins": "Soutenez le créateur avec des Huzty Coins",
      ...
      "Sent gifts message": "Vous avez envoyé {{amount}} Huzty Coins à {{name}} !",
  ...
  ru: {
    translation: {
      ...
      "Support creator coins": "Поддержите автора с помощью Huzty Coins",
      ...
      "Sent gifts message": "Вы отправили {{amount}} Huzty Coins пользователю {{name}}!",
  ...
  zh: {
    translation: {
      ...
      "Save Changes": "保存更改",
      "Send Gift": "发送礼物",
      "Support creator coins": "用 Huzty Coins 支持创作者",
      ...
      "Sent gifts message": "您向 {{name}} 发送了 {{amount}} 个 Huzty Coins！",
