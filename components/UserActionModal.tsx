      ...
      >
        <div className="p-8 flex flex-col items-center text-center">
          <div className="relative mb-6">
            <div className="w-24 h-24 rounded-full border-4 border-purple-600 p-1 shadow-xl shadow-purple-600/20">
          ...
          <div className="w-full space-y-3">
            ...
            {isHost && userId !== currentUser?.id && (
              <div className="grid grid-cols-2 gap-3 pt-4 border-t border-white/5">
                ...
                <button 
                  onClick={handleBlock}
                  className="col-span-2 flex items-center justify-center gap-2 p-4 bg-purple-600/10 border border-purple-600/20 rounded-2xl text-purple-500 hover:bg-purple-600/20 transition-all"
                >
                  <Ban size={18} />
