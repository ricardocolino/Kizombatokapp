          ...
          <div className="h-full w-full relative bg-transparent">
            ...
            <div className="absolute top-10 right-6 flex flex-col gap-6 z-50">
              ...
              >
                ...
                <span className={`text-[8px] font-black uppercase shadow-sm ${isFlashOn ? 'text-purple-600' : 'text-white'}`}>{t('Flash')}</span>
              </button>
            </div>
            ...
            <div className="absolute bottom-12 left-0 w-full flex flex-col items-center gap-6 z-40">
              ...
              <div className="flex gap-8 pb-2">
                ...
                <button 
                  onClick={onStartLive}
                  className="text-[11px] font-black uppercase tracking-[0.2em] transition-all text-white/40 hover:text-purple-600"
                >
                  {t('Live')}
                </button>
              </div>
