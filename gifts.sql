...
-- 1. Tabela de Tipos de Presentes (Definição)
...
-- 2. Tabela de Presentes Enviados em Lives
...
-- 5. Inserir alguns presentes iniciais
...
-- 6. Função RPC para enviar presente (Transação Atómica)
...
-- 7. Habilitar Realtime para live_gifts
